...
with lib; {
  wayland.windowManager.hyprland = {
    ...
    in concatStrings [ ''
      ...
      bind = ${modifier},space,exec,hyprctl dispatch layoutmsg togglesplit
      ...
      bind = ${modifier},v,focusmaster,
      
      # Window movement
      bind = ${modifier},Return,swapwithmaster,
      ...
      # Resize (XMonad-style)
      bind = ${modifier},h,resizeactive,-40 0
      bind = ${modifier},l,resizeactive,40 0
      ...
      # Layout switching
      bind = ${modifier},space,exec,hyprctl keyword general:layout "dwindle"
      bind = ${modifier}CONTROL,space,exec,hyprctl keyword general:layout "master"
