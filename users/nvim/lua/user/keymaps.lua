...
nnoremap('<leader>dd', require('telescope.builtin').diagnostics, { desc = '[S]earch [D]iagnostics' })
...
M.map_lsp_keybinds = function(buffer_number)
    ...
    nnoremap('<leader>cd', vim.lsp.buf.definition, { desc = 'LSP: [G]oto [D]efinition', buffer = buffer_number })
