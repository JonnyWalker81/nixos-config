...
vim.opt.guifont = { "JetBrains_Mono", ":h20" }
...
vim.keymap.set('n', '<leader>dd', require('telescope.builtin').diagnostics, { desc = '[S]earch [D]iagnostics' })
...
wk.register({
  ...
  w = {
        ...
        w = { "<cmd>wincmd w<cr>", "Switch Window" },
    },
  t = {
        name = "terminal",
